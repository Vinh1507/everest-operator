...
func (in *ClusterGroupStatus) DeepCopyInto(out *ClusterGroupStatus) {
	*out = *in
	...
	if in.ClusterGenerations != nil {
		in, out := &in.ClusterGenerations, &out.ClusterGenerations
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpsRequestClusterStatus) DeepCopyInto(out *OpsRequestClusterStatus) {
	*out = *in
	if in.Output != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpsRequestClusterStatus.
func (in *OpsRequestClusterStatus) DeepCopy() *OpsRequestClusterStatus {
	if in == nil {
		return nil
	}
	out := new(OpsRequestClusterStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpsRequestStatus) DeepCopyInto(out *OpsRequestStatus) {
	*out = *in
	if in.ClusterStatus != nil {
		...
		*out = make([]OpsRequestClusterStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
